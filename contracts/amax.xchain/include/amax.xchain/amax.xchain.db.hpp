...
TBL xin_order_t {
    ...
    EOSLIB_SERIALIZE(xin_order_t,   (id)(txid)(amc_txid)(account)(mulsign_wallet_id)(xin_from)(xin_to)
...
TBL xout_order_t {
    ...
    EOSLIB_SERIALIZE(xout_order_t,  (id)(txid)(amc_txid)(account)(mulsign_wallet_id)(xout_from)(xout_to)(chain)(coin_name)
