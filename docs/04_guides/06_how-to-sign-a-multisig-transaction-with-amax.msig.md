---
content_title: How to sign a multisig transaction with amax.msig
link_text: How to sign a multisig transaction with amax.msig
---

### amax.msig

### Prerequisites:
   - amax.token contract installed to amax.token account, amax.msig contract installed on amax.msig account which is a priviliged account.
...
#    amax.msig <= amax.msig::propose          {"proposer":"tester","proposal_name":"test","requested":[{"actor":"treasury","permission":"active"}]...
```
...
#    amax.msig <= amax.msig::approve          {"proposer":"tester","proposal_name":"test","level":{"actor":"treasury","permission":"active"}}
```
...
#    amax.msig <= amax.msig::exec             {"proposer":"tester","proposal_name":"test","executer":"tester"}
```
